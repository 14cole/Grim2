...
class PlotOpsMixin:
    ...
    def _style_axes(self, ax) -> None:
        ...
        ax.set_facecolor(bg)
        grid_on = self.chk_plot_grid_visible.isChecked()
    ...
    def _legend_kwargs(self) -> dict[str, object]:
        kwargs: dict[str, object] = {"loc": "upper center"}
    ...
    def _configure_legend(self, legend, ax=None) -> None:
        ...
        try:
            ...
            legend.set_bbox_to_anchor((0.5, 0.98), transform=ax.transAxes)
        except Exception:
            pass
        try:
