...
class GrimCutWindow(DatasetOpsMixin, PlotOpsMixin, QMainWindow):
    def __init__(self) -> None:
        ...
        for label, attr in (
            ("BG Subtract", "btn_bg_subtract"),
            ("Cal Norm", "btn_cal_norm"),
        ...
        self.btn_bg_subtract.clicked.connect(self._bg_subtract_selected)
        self.btn_cal_norm.clicked.connect(self._cal_norm_selected)
        self.btn_time_gate.clicked.connect(self._time_gate_selected)
        self.btn_bw_avg.clicked.connect(self._bw_avg_selected)
